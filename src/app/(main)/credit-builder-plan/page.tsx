...
import CreditBuilderPlans from "@/components/custom/Services/CreditBuilder/CreditBuilderPlans";
...
const CreditBuilder = () => {
  ...
  useEffect(() => {
    ...
    // Also clear any other payment-related items that might cause conflicts
    const keysToRemove = [];
    for (let i = 0; i < localStorage.length; i++) {
      const key = localStorage.key(i);
      if (key && (key.includes("txnId") || key.includes("transaction"))) {
        ...
        <div className="bg-white shadow-xl rounded-lg overflow-hidden">
          <div className="p-8">
            <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
              Choose Your Credit Builder Plan
            </h2>
