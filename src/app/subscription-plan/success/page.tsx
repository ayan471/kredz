...
const page = () => {
  return (
    <div className="min-h-[440px] flex flex-col text-center align-center justify-center">
      <Image className="m-auto max-w-[240px]" src={SuccessImage} alt="Success Image" width="520" height="520"/>
      ...
      <Link href="/dashboard"><Button className="max-w-min m-auto">Go To Dashbaord</Button></Link>
    </div>
  )
}
