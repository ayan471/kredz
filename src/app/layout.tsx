...
export default function RootLayout({
  ...
  return (
    ...
    >
      <html
        lang="en"
        className={`max-w-[1920px] mx-auto w-full ${myFont.variable} ${dancingScript.variable} ${SedgwickAve.variable} ${BethEllen.variable} ${EduVICWANTBeginner.variable} ${UrbanistLight.variable} scroll-smooth`}
      >
